...
KonjueView::KonjueView(QWidget *parent)
    : QWidget(parent),
      DCOPObject("KonjueIface")
{
...
KonjueView::~KonjueView()
{
}

void KonjueView::print(QPainter *p, int height, int width)
{
    // do the actual printing, here
    // p->drawText(etc..)
}

void KonjueView::slotSetTitle(const QString& title)
{
    emit signalChangeCaption(title);
}
#include "konjueview.moc"
